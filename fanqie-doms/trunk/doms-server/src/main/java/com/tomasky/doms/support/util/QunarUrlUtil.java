...
public class QunarUrlUtil {
     ...
     * @return
     */
    public static String getRefuseOrderUrl() {
        String resuseOrderUrl = ResourceBundleUtil.getString("qunar.refuse.order");
        return CommonApi.getQunarUrl() + resuseOrderUrl;
    }
    ...
    public static String getConfirmOrderUrl() {
        String confirmUrl = ResourceBundleUtil.getString("qunar.confirm.order");
        return CommonApi.getQunarUrl() + confirmUrl;
    }
