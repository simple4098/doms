...
import com.tomasky.doms.utils.JointWisdomUtils;
...
public class JointWisdomOrderErrorResponse extends OtaRequest {
    ...
    public static JointWisdomOrderErrorResponse getBasicError(String responseType, String version, String errorText) {
        JointWisdomOrderErrorResponse result = new JointWisdomOrderErrorResponse();
